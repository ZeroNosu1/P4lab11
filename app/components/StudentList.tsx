  ...
  return (
    <div className="space-y-4">
      <div className="flex justify-between items-center">
        <h2 className="text-2xl font-bold text-gray-800">รายชื่อนักเรียน ({students.length} คน)</h2>
        <Link
          href="/add"
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
        {students.map((student) => (
          <div key={student.id} className="bg-white rounded-lg shadow-md p-4 border">
            <div className="mb-3">
            ...
            <div className="mb-3 text-sm text-gray-700">
              ...
              <p><span className="font-medium">เบอร์:</span> {student.phone}</p>
            </div>

            <div className="text-xs text-gray-500 mb-3">
              <p>สมัครเมื่อ: {new Date(student.createdAt).toLocaleDateString('th-TH')}</p>
            </div>
